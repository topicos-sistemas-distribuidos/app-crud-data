...
public class ConvidadoController {
	...
	public String processaAlterar(@RequestParam("id") Long id, @RequestParam("nome") String nome, @RequestParam("email") String email, @RequestParam("telefone") String telefone, Model model ){
